  ...
  return (
    <section id="experience" className="text-white pb-14">
      ...
      <div className="flex px-6 gap-6 ">      
          ...
          <div className="flex py-6 justify-between px-6">
            <div className="flex flex-col gap-2">
              <h3 className="text-2xl font-semibold">Rapidsoft Technologies</h3>
              <h3 className="text-xl text-[#e173e5] leading-snug font-medium">
                Frontend Developer Intern
              </h3>
            </div>
            <div className=" flex flex-col gap-1">
              <p className="text-lg">July 2024 - August 2024</p>
              <p className="text-sm text-zinc-200">On-Site</p>
            </div>
          </div>
          <div className="text-lg px-6">
            <ul className="flex gap-3 flex-col list-disc pl-6">
              <li>
          ...
          <div className="flex gap-2 pl-10 pt-5">
