      ...
      <div>
        ...
        <div>
          <form className="flex flex-col">
            <div className="mb-6">
            <label htmlFor="email" type="email" className="text-white block text-sm font-medium mb-2">
              Your email
            </label>
            <input
              type="email"
           ...
           <div className="mb-6">
           <label htmlFor="subject" type="email" className="text-white block text-sm font-medium mb-2">
              Subject
            </label>
            <input
              type="text"
